...
#pragma warning(default: 26495)
    ...
    void Name(const char *name, uint16_t len) const
    {
...
private:
    ...
    tracy_force_inline ID3D11Query *GetQueryObjectFromId(uint32_t id) const
    {
        return m_queries[id];
    }
...
#define TracyD3D11UnnamedZoneX                                      TracyD3D11UnnamedZone 
#define TracyD3D11ZoneX( ctx, name )                                TracyD3D11Zone( ctx, name ) 
#define TracyD3D11ZoneXC( ctx, name, color )                        TracyD3D11ZoneC( ctx, name, color ) 
#define TracyD3D11NamedZoneX( ctx, varname, name, active )          TracyD3D11NamedZone( ctx, varname, name, active ) 
#define TracyD3D11NamedZoneXC( ctx, varname, name, color, active )  TracyD3D11NamedZoneC( ctx, varname, name, color, active ) 
#define TracyD3D11ZoneTransientX(ctx, varname, name, active)        TracyD3D11ZoneTransient(ctx, varname, name, active) 

#define TracyD3D11ZoneXS( ctx, name, depth, active )                        TracyD3D11ZoneS( ctx, name, depth, active ) 
#define TracyD3D11ZoneXCS( ctx, name, color, depth, active )                TracyD3D11ZoneCS( ctx, name, color, depth, active ) 
#define TracyD3D11NamedZoneXS( ctx, varname, name, depth, active )          TracyD3D11NamedZoneS( ctx, varname, name, depth, active ) 
#define TracyD3D11NamedZoneXCS( ctx, varname, name, color, depth, active )  TracyD3D11NamedZoneCS( ctx, varname, name, color, depth, active ) 
#define TracyD3D11ZoneTransientXS(ctx, varname, name, depth, active)        TracyD3D11ZoneTransientS(ctx, varname, name, depth, active) 
#else
#define TracyD3D11UnnamedZoneX                                      
#define TracyD3D11ZoneX( ctx, name )                                
#define TracyD3D11ZoneXC( ctx, name, color )                        
#define TracyD3D11NamedZoneX( ctx, varname, name, active )          
#define TracyD3D11NamedZoneXC( ctx, varname, name, color, active )  
#define TracyD3D11ZoneTransientX(ctx, varname, name, active)        

#define TracyD3D11ZoneXS( ctx, name, depth, active )                        
#define TracyD3D11ZoneXCS( ctx, name, color, depth, active )                
#define TracyD3D11NamedZoneXS( ctx, varname, name, depth, active )          
#define TracyD3D11NamedZoneXCS( ctx, varname, name, color, depth, active )   
#define TracyD3D11ZoneTransientXS(ctx, varname, name, depth, active)        
#endif
