...
namespace WellEngine::D3D11FormatData
{
	...
	[[nodiscard]] inline const DXGI_FORMAT *GetTypedLinearList(int *count)
	{
		static const DXGI_FORMAT linearList[] = {
			DXGI_FORMAT_UNKNOWN,
			DXGI_FORMAT_R32G32B32A32_FLOAT,
			DXGI_FORMAT_R32G32B32A32_UINT,
			DXGI_FORMAT_R32G32B32A32_SINT,
		...
		if (count)
			*count = sizeof(linearList) / sizeof(DXGI_FORMAT);

		return linearList;
	}

	[[nodiscard]] inline const DXGI_FORMAT *GetCommonLinearList(int *count)
	{
		static const DXGI_FORMAT linearList[] = {
			DXGI_FORMAT_UNKNOWN,
			DXGI_FORMAT_R32G32B32A32_FLOAT,
