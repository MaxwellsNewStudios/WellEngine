...
// Macro for generating random color at compile time
#define RandomUniqueColor() (const uint32_t)WellEngine::ConstRand((const size_t)__COUNTER__, (const size_t)0x000000, (const size_t)0xFFFFFF)
