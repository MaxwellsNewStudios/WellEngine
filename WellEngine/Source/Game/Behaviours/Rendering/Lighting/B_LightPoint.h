...
namespace WellEngine
{
	...
	private:
		...
		B_CameraCube *_shadowCameraCube = nullptr;
	...
	public:
		B_LightPoint() = default;
		B_LightPoint(B_CameraCube *cameraCube, dx::XMFLOAT3 color, float falloff, float fogStrength, UINT updateFrequency = 3);
		B_LightPoint(CameraPlanes planes, dx::XMFLOAT3 color, float falloff, float fogStrength, UINT updateFrequency = 3);
		~B_LightPoint();
		...
		[[nodiscard]] B_CameraCube *GetShadowCameraCube() const;
