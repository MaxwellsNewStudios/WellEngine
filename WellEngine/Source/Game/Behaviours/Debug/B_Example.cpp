...
bool B_Example::Update(TimeUtils &time, const Input &input)
{
	...
	if (!_firstFrame && !_hasCreatedChild && input.GetKey(KeyCode::Y) == KeyState::Pressed)
	{
		...
		// Duplicate example behaviour
		{
			...
			B_Example *behaviour = new B_Example();
...
bool B_Example::Serialize(json::Document::AllocatorType &docAlloc, json::Value &obj)
{
...
bool B_Example::Deserialize(const json::Value &obj, Scene *scene)
{
