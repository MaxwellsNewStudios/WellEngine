...
namespace WellEngine
{
	...
	constexpr UINT CUTSCENE_POINT_COUNT = 10;
	...
	private:
		...
		dx::XMFLOAT3A _movePoints[CUTSCENE_POINT_COUNT] {
		...
		dx::XMFLOAT4A _rotationPoints[CUTSCENE_POINT_COUNT]{
		...
		float _speedPoints[CUTSCENE_POINT_COUNT]{
			3.0f,		// Start 1.1
			5.0f,		// Start 1.2
			5.0f,		// Start 1.3
			3.0f,		// Start 1.4
