...
{
	class [[register_behaviour]] B_SoundSource : public Behaviour
	{
	public:
		const std::string &GetName() const override { return "SoundSource"; }
	...
	public:
		B_SoundSource() = default;
		B_SoundSource(std::string fileName, 
