...
namespace WellEngine
{
	...
	public:
		B_BoxCollider(const dx::XMFLOAT3A &halfExtents = { 1, 1, 1 }, const dx::XMFLOAT3A &offset = { 0, 0, 0 });
		B_BoxCollider(const dx::XMFLOAT3A &halfExtents, const dx::XMFLOAT3A &offset,
